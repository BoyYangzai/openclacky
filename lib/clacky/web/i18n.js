...
const I18n = (() => {
  ...
  const TRANSLATIONS = {
    en: {
      ...
      "chat.videoVision":    "Reading video…",
      "chat.audioStt":       "Transcribing audio…",
      ...
      "chat.input.interruptMode": "Interrupt and run",
      "chat.input.steerMode": "Guide current task",
      "chat.input.queued": "Queued task",
      "chat.input.queueMode": "Queue task",
      "chat.input.queueDescription": "Run after the current task completes.",
      "chat.input.guidancePending": "Waiting for current task to receive guidance",
      "chat.input.guidanceClosed": "The current task is not accepting guidance",
      "chat.input.guidanceRejected": "The task is no longer accepting guidance. Your message remains queued.",
      "chat.input.stoppingDelayed": "The current task is still stopping. Your message remains queued; try again once it stops.",
      "chat.input.stopping": "Stopping current task…",
      "chat.input.editQueued": "Edit",
      "chat.input.saveQueued": "Save",
      "chat.input.sendQueued": "Interrupt and run",
      ...
      "workspace.openedInSystem": "Opened it in your default application.",
      ...
      "extensions.group.official":   "Official",
      "extensions.group.brand":      "Brand",
      "extensions.group.user":       "User",
      ...
      "extensions.action.enabling":        "Enabling",
      "extensions.action.disabling":       "Disabling",
      "extensions.action.installFailed":   "Install failed",
      "extensions.action.remove":          "Uninstall",
      "extensions.action.removeConfirm":   "Uninstall this extension? Its files will be deleted. You can reinstall it later.",
      "extensions.action.removePurgeData": "Also delete this extension's data (kept by default; reinstalling restores it)",
      "extensions.removeFailed":           "Could not uninstall the extension",
      "extensions.action.manage":          "Manage",
      "extensions.action.more":            "More",
      ...
      "settings.models.field.modelPlaceholder": "Type or pick a model",
      ...
      "settings.models.loadEmpty":         "Endpoint returned no models",
      "settings.models.loadFailed":        "Couldn't load models: {{msg}}",
      "settings.models.fetchedFrom":       "Fetched from {{endpoint}} · {{count}} models",
    ...
    zh: {
      ...
      "chat.thinking":       "思考中…",
      "chat.vision":         "识别图片内容…",
      "chat.videoVision":    "理解视频内容…",
      "chat.audioStt":       "转写语音内容…",
      "chat.retrying":       "正在重试",
      ...
      "chat.input.interruptMode": "打断并执行",
      "chat.input.steerMode": "引导当前任务",
      "chat.input.queued": "待执行",
      "chat.input.queueMode": "排队执行",
      "chat.input.queueDescription": "当前任务完整结束后，按顺序执行",
      "chat.input.guidancePending": "等待当前任务接收引导",
      "chat.input.guidanceClosed": "当前任务已不再接收引导",
      "chat.input.guidanceRejected": "当前任务已不再接收引导，消息仍保留在队列中。",
      "chat.input.stoppingDelayed": "当前任务尚未停止，消息已保留在队列中，请停止后重试。",
      "chat.input.stopping": "正在停止当前任务…",
      "chat.input.editQueued": "编辑",
      "chat.input.saveQueued": "保存",
      "chat.input.sendQueued": "打断并执行",
      ...
      "workspace.openedInSystem": "已用系统默认程序打开",
      ...
      "extensions.group.official":   "官方",
      "extensions.group.brand":      "品牌",
      "extensions.group.user":       "用户",
      ...
      "extensions.action.enabling":        "启用中",
      "extensions.action.disabling":       "禁用中",
      "extensions.action.installFailed":   "安装失败",
      "extensions.action.remove":          "卸载",
      "extensions.action.removeConfirm":   "确定卸载此扩展？相关文件会被删除，之后可重新安装。",
      "extensions.action.removePurgeData": "同时删除该扩展的数据（默认保留，重新安装会自动恢复）",
      "extensions.removeFailed":           "卸载扩展失败",
      "extensions.action.manage":          "管理",
      "extensions.action.more":            "更多",
      ...
      "settings.models.search.placeholder": "搜索模型 / 服务商 / 备注 / 接口地址",
      ...
      "settings.media.field.baseUrl": "接口地址",
      "settings.media.field.apiKey":  "API 密钥",
      ...
      "settings.media.apiKey.placeholder": "请输入 API 密钥",
      "settings.media.apiKey.required":    "请填写 API 密钥",
      "settings.media.model.required":     "请填写模型名称",
      "settings.media.baseUrl.required":   "请填写接口地址",
      ...
      "settings.models.field.modelPlaceholder": "输入或选择模型",
      "settings.models.field.baseurl":    "接口地址",
      "settings.models.field.apikey":     "API 密钥",
      ...
      "settings.models.loadingModels":     "正在加载模型…",
      "settings.models.loadEmpty":         "该接口未返回模型",
      "settings.models.loadFailed":        "加载模型失败：{{msg}}",
      "settings.models.fetchedFrom":       "已从 {{endpoint}} 获取 · {{count}} 个模型",
      ...
      "onboard.key.baseurl":        "接口地址",
      "onboard.key.apikey":         "API 密钥",
      ...
      "onboard.manual.toggle":      "使用自己的 API 密钥手动配置",
  ...
  function t(key, vars = {}) {
    ...
    Object.entries(vars).forEach(([k, v]) => {
      // Function replacement: unlike the string form it never interprets `$`
      // patterns (`$&`, `$$`…) inside the value — interpolated values can
      // carry remote-origin text (e.g. model-list errors) that must appear
      // verbatim.
