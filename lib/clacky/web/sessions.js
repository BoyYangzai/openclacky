...
const Sessions = (() => {
  ...
  function _docTypeIcon(mimeType, filename) {
    ...
    if ((mimeType && mimeType.startsWith("video/")) ||
        ...
        lower.endsWith(".mkv") || lower.endsWith(".avi") || lower.endsWith(".m4v")) return "🎬";
    if ((mimeType && mimeType.startsWith("audio/")) ||
        lower.endsWith(".mp3") || lower.endsWith(".wav") || lower.endsWith(".m4a") ||
        lower.endsWith(".ogg") || lower.endsWith(".flac") || lower.endsWith(".aac")) return "🎵";
    return "📎";
  }
  ...
  function _attachmentBadge(name, mimeType) {
    ...
    return `<span class="msg-pdf-badge">` +
      `<span class="msg-pdf-badge-icon">${_docTypeIcon(mimeType, fname)}</span>` +
